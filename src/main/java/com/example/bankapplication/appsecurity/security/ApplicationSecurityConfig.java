...
import com.example.bankapplication.appsecurity.auth.ApplicationUserService;
import com.example.bankapplication.appsecurity.jwt.JwtConfig;
import com.example.bankapplication.appsecurity.jwt.JwtTokenVerifier;
import com.example.bankapplication.appsecurity.jwt.JwtUsernameAndPasswordAuthenticationFilter;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http
        ...
        .antMatchers("/bank/**").hasRole(ADMIN.name())
        .anyRequest()
        .authenticated();
  }
